      ...
      <div className="bg-primary py-24 md:py-40 text-white relative overflow-hidden">
        ...
        <div className="section-container relative z-10">
          <motion.h1 
            ...
            className="text-4xl sm:text-5xl md:text-7xl font-black text-white mb-6 tracking-normal leading-tight"
          >
      ...
      <div className="section-container section-padding">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary mb-10 leading-snug tracking-normal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32">
          ...
          >
            ...
            <h3 className="text-3xl font-black text-primary mb-8 uppercase tracking-normal leading-snug">
        ...
        <div className="bg-primary-dark rounded-[4rem] p-16 md:p-24 text-white text-center border-b-[16px] border-accent relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-24 uppercase tracking-widest leading-snug relative z-10">
